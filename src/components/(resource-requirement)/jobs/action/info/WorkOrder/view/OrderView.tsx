...
export function OrderView({ candidate }: candidateProfileProps) {
        ...
        <div className=" p-3 space-y-2.5">
            ...
            <div className="space-y-2 px-2">
                ...
                <div className="grid grid-cols-3 gap-3 text-xs">
                    ...
                    <div>
                        <p className="text-label mb-1">Work Start Date (Est.) </p>
                    ...
                    <div>
                        <p className="text-label mb-1">Contract Duration</p>
                       ...
                       <div>
                        <p className="text-label mb-1">Work End Date (Est.)</p>
                                    ...
                                    <div className="mt-1.5 rounded-lg border ">
                                        <div className="p-3 space-y-1.5">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-xs font-bold">
                                                    {sym}
                                                    {candidate.compensation.forceManagementfee}
                                                </span>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
