...
export default function New() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 h-full relative">
        <div className="col-span-1 lg:col-span-3 bg-card p-2 rounded-md ">
          <div className=" sticky top-6 flex flex-col justify-start items-start space-y-4">
            ...
            <RadioGroup.Root
              defaultValue={"0"}
              className="xs:max-w-sm lg:max-w-none w-full grid grid-cols-2 lg:grid-cols-1 max-h-96 gap-3"
            >
              <RadioGroup.Item
                value={"0"}
              ...
              <RadioGroup.Item
                value={"1"}
                onClick={() => {
                  router.push("/resource-requirement/jobs/action/manual");
                }}
                className="ring-[1px] ring-border rounded py-1 px-3 data-[state=checked]:bg-primary data-[state=checked]:text-white cursor-pointer space-y-1"
              >
                <div className="p-4 text-left">
